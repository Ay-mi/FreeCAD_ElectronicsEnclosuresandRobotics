...
def run():
    ...
    # -----------------------
    cut_obj = doc.addObject("Part::Feature", "USB_C_Cut")
    cut_obj.Shape = shape
    doc.recompute()
...
class EnclosureMacro3_Command_Class:
...
Gui.addCommand('usbc_cut', EnclosureMacro3_Command_Class())
