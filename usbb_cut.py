...
def run():
    ...
    # -----------------------
    cut_obj = doc.addObject("Part::Feature", "USB_B_Cut")
    cut_obj.Shape = shape
    doc.recompute()
...
class EnclosureMacro4_Command_Class:
...
Gui.addCommand('usbb_cut', EnclosureMacro4_Command_Class())
