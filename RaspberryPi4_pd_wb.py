...
def run():
    ...
    App.Console.PrintMessage("Running Enclosure Macro 2\n")
...
class EnclosureMacro2_Command_Class:
    def GetResources(self):
        ...
        return {
            'Pixmap': icon_path,
            'MenuText': 'Create Raspberry Pi 4 Enclosure Box',
...
FreeCADGui.addCommand('RaspberryPi4_pd_wb_Command', EnclosureMacro2_Command_Class())
